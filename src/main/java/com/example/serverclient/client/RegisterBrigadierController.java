...
public class RegisterBrigadierController {
    @FXML
    ...
    protected void onRegisterButtonClick() {
        if(loginField.getText().isEmpty() || passwordField.getText().isEmpty() || datePicker.getValue()==null || nameField.getText().isEmpty())
            return;
        ClientApplication.connection.registerRequest(UserType.Brigadier, loginField.getText(), passwordField.getText(), nameField.getText(), datePicker.getValue());
    }
    @FXML
